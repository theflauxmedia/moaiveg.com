  ...
  const experiences = [
    {
      ...
      description: "Step into an oasis of calm. Our green-themed decor is designed to soothe the senses and provide the perfect backdrop for your dining experiences.",
