  ...
  const experiences = [
    {
      ...
      description: "Step into an oasis of calm. Our green-themed decor is designed to soothe the senses and provide the perfect dining experiences.",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {experiences.map((experience, index) => (
            <Card 
              key={index} 
              className="group overflow-hidden border-0 shadow-elegant hover:shadow-glow transition-smooth animate-luxury-slide royal-border hover:royal-glow hover-lift"
